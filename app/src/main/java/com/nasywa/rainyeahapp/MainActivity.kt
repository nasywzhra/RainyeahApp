package com.nasywa.rainyeahapp
...
import com.nasywa.rainyeahapp.models.WeatherResponse
import com.nasywa.rainyeahapp.network.Constants
import com.nasywa.rainyeahapp.network.Constants.API_KEY
import com.nasywa.rainyeahapp.network.Constants.METRIC_UNIT
import com.nasywa.rainyeahapp.network.WeatherConfig
    ...
    private fun setupUI(responseBody: WeatherResponse) {
        for (i in responseBody.weather.indices) {
            ...
            when(responseBody.weather[i].icon){
                "01d" -> ivWeather.setImageResource(R.drawable.cloud)
